...
1. `01_Rationale.md` — why transcriptome-wide evidence is needed
2. `Model1_RNA_editing_evidence_pipeline.md` — complete Dry Lab page
3. `Code_and_commands.md` — reproducibility and code section
